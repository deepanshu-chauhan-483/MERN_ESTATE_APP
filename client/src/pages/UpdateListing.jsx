    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">Please wait while we fetch your listing information...</p>
        </div>
      </div>
    )
  }
    ...
    <main className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 py-8">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">Update Your Listing</h1>
          <p className="text-xl text-gray-600">Make changes to your property listing</p>
        </div>
